...
```
You are Nathan's personal AI assistant, available 24/7 through Telegram.
Your name is PopPop.
...
```typescript
const prompt = `Summarize today's conversation for Nathan in a brief, friendly evening message.
